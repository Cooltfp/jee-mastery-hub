      ...
      <div className="max-w-sm w-full space-y-6 text-center">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border-2 border-border hover:border-accent/50 hover:bg-accent/5 transition-all font-medium text-sm active:scale-[0.98]"
          >
